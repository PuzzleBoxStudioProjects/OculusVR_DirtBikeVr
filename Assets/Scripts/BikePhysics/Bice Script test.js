...
private var centerOfMass=Vector3(0,-0.25,1);
...
function Start(){
	...
	frontJoint.radius=frontWheelSize.y * transform.lossyScale.y / 2;
	frontJoint.suspensionDistance = 0.1;
	...
	rearJoint.radius=rearWheelSize.y * transform.lossyScale.y / 2;
	rearJoint.suspensionDistance = 0.1;
