...
var suspensionRange : float;
var suspensionDamper : float;
var suspensionSpringFront : float;
var suspensionSpringRear : float;
...
function UpdateDrag(relativeVelocity : Vector3)
{
	...
	rigidbody.AddForce(Vector3.forward * rigidbody.mass * Time.deltaTime);
}
